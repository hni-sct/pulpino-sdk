...
OBJDUMP=${PREFIX}/riscv32-unknown-elf-objdump
OBJCOPY=${PREFIX}/riscv32-unknown-elf-objcopy

COMPILER=${PREFIX}/riscv32-unknown-elf-gcc
RANLIB=${PREFIX}/riscv32-unknown-elf-ranlib

TARGET_C_FLAGS="-O3 -march=rv32im -mabi=ilp32 -g"
